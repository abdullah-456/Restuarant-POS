...
<head>
    ...
    <style>
        ...
        body { font-family: 'Courier New', monospace; width: 72mm; margin: 0 auto; padding: 5mm; font-size: 14px; line-height: 1.2; }
        .text-center { text-align: center; }
        .bold { font-weight: bold; }
        .dashed-line { border-bottom: 2px dashed #000; margin: 10px 0; }
        .order-head { font-size: 18px; margin-bottom: 5px; }
        .type-badge { background: #000; color: #fff; padding: 2px 5px; font-size: 12px; }
        table { width: 100%; border-collapse: collapse; }
        td { padding: 8px 0; border-bottom: 1px dotted #ccc; }
        .notes { font-size: 12px; font-style: italic; color: #333; margin-top: 4px; display: block; }
        .new-tag { border: 1px solid #000; padding: 1px 3px; font-size: 10px; margin-right: 5px; }
    </style>
</head>
<body>
