...
@section('title', 'Edit Deal - ' . $item->name)
                ...
                <div class="lg:col-span-2 space-y-6">
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                        <h3 class="text-lg font-bold text-gray-800 mb-4 flex items-center gap-2">
                            <i class="fas fa-edit text-emerald-500"></i>Update Deal Information
                        </h3>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-1 gap-4">
                                <div>
                                    ...
                                    <input type="number" name="price" value="{{ old('price', $item->price) }}" min="0"
                                        step="0.01" required
                            ...
                            <div>
                                ...
                                <textarea name="description" rows="3"
                                    class="w-full border border-gray-300 rounded-xl px-4 py-2.5 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition shadow-sm"
                                    placeholder="Tell customers what's in this deal...">{{ old('description', $item->description) }}</textarea>
                ...
                <div class="space-y-6">
                                ...
                                <div class="relative group">
                                    ...
                                    <label for="imageInput" class="cursor-pointer block">
                                        <div
                                            ...
                                            <p class="text-xs text-gray-500 font-medium">Click to change image</p>
                                        </div>
                                    </label>
                                </div>
                    ...
                    <div class="flex flex-col gap-3">
                        <button type="submit"
                            ...
                            <i class="fas fa-check-circle text-lg"></i>Update Deal
                        </button>
    ...
    <script>
        ...
        window.addEventListener('load', function () {
            @if(old('deal_items'))
                ...
                @endforeach
            @elseif($item->dealItems->count() > 0)
                @foreach($item->dealItems as $di)
                    addDealItemRow('{{ $di->menu_item_id }}', '{{ $di->quantity }}');
                @endforeach
            @else
                addDealItemRow();
