    ...
    <div class="sidebar fixed left-0 top-0 h-full w-64 bg-gradient-to-b from-blue-900 to-blue-800 text-white shadow-lg z-50" id="sidebar">
        <div class="p-4 md:p-6 border-b border-blue-700">
            <div class="flex items-center justify-between">
                <h1 class="text-lg md:text-xl font-bold sidebar-text">POS · Cashier</h1>
        ...
        <nav class="mt-4 md:mt-6 overflow-y-auto" style="max-height: calc(100vh - 200px);">
            <a href="{{ route('cashier.dashboard') }}" class="flex items-center px-4 md:px-6 py-2.5 md:py-3 text-white hover:bg-blue-700 transition {{ request()->routeIs('cashier.dashboard') ? 'bg-blue-700 border-r-4 border-yellow-400' : '' }}">
