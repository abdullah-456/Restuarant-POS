...
<head>
    ...
    <style>
        ...
        .nav-link.active { background: rgba(255,255,255,0.18); color: white; box-shadow: inset 3px 0 0 #facc15; }
...
<body class="bg-gray-50">
    ...
    <div class="sidebar fixed left-0 top-0 h-full w-64 bg-gradient-to-b from-blue-900 to-blue-800 text-white shadow-2xl z-50 flex flex-col" id="sidebar">
        ...
        <div class="px-4 py-5 border-b border-white/10 flex-shrink-0">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3 sidebar-text">
                    <div class="w-9 h-9 bg-gradient-to-br from-blue-400 to-blue-600 rounded-xl flex items-center justify-center shadow-lg">
        ...
        <nav class="flex-1 overflow-y-auto py-4 space-y-0.5">
            <div class="px-4 mb-1">
                <p class="text-[10px] uppercase tracking-widest text-white/30 font-semibold px-2 sidebar-text">Navigation</p>
            </div>
            ...
            <div class="px-4 mt-4 mb-1">
                <p class="text-[10px] uppercase tracking-widest text-white/30 font-semibold px-2 sidebar-text">Displays</p>
            </div>
        ...
        <div class="flex-shrink-0 p-4 border-t border-white/10 bg-black/20">
            <div class="flex items-center gap-3 mb-3">
                <div class="w-8 h-8 bg-gradient-to-br from-blue-400 to-indigo-600 rounded-full flex items-center justify-center text-white text-sm font-bold flex-shrink-0">
            ...
            <div class="px-4 md:px-6 py-3 md:py-4">
                <div class="flex justify-between items-center">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h2 class="text-lg md:text-xl font-bold text-gray-900 leading-tight">@yield('page-title', 'Dashboard')</h2>
                        </div>
                    </div>
                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex items-center gap-2 bg-gray-100 rounded-full px-3 py-1.5">
                            <div class="w-5 h-5 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center">
